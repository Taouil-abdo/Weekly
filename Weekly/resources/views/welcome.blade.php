                                        ...
                                        <div class="flex flex-1 flex-col justify-between bg-white p-6">
                                            <div class="flex-1">
                                                ...
                                                <a href="#" class="mt-2 block">
                                                    <p class="text-xl font-semibold text-gray-900">{{$post->titre}}Boost your conversion
                                                        rate</p>
                                                    <p class="mt-3 text-base text-gray-500">{{$post->description}}Lorem ipsum dolor sit amet
                                            ...
                                            <div class="mt-6 flex items-center">
                                                ...
                                                <div class="ml-10">
                                                        <button class="w-full bg-slate-300 h-12 rounded-lg hover:bg-gray-800 hover:text-stone-50">
